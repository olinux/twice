...
public class TWICEModuleGenerator extends Generator {
	...
	private JClassType getGenericClass(JClassType classType) {
		...
		for (JClassType intf : classType.getImplementedInterfaces()) {
			if (intf.getQualifiedSourceName().equals(
					TWICEModule.class.getName())) {
	...
	public String generate(TreeLogger logger, GeneratorContext context,
		...
		try {
			...
			if (src != null) {		
				...
				src.println("public "+Map.class.getName()+"<"+String.class.getName()+", "+Object.class.getName()+"> getConfigurableFields("+genericClass.getQualifiedSourceName()+" instance){");
				src.println(Map.class.getName()+"<"+String.class.getName()+", "+Object.class.getName()+"> result = new "+HashMap.class.getName()+"<"+String.class.getName()+", "+Object.class.getName()+">();");
				...
				src.println("@Override");
				src.println("public void configure("+Map.class.getName()+"<"+String.class.getName()+", "+String.class.getName()+"> properties, "+genericClass.getQualifiedSourceName()+" instance){");
				...
				src.println("@Override");
				src.println("public "+RunAsyncCallback.class.getName()+" instantiate(final "+AsyncCallback.class.getName()+"<"+genericClass.getQualifiedSourceName()+"> callback){");
				src.println("return new "+RunAsyncCallback.class.getName()+"(){");
				src.println("@Override");
				src.println("public void onSuccess(){");
				src.println(genericClass.getQualifiedSourceName()+" module = "+GWT.class.getName()+".create("+genericClass.getQualifiedSourceName()+".class);");
	...
	public SourceWriter getSourceWriter(JClassType classType,
		...
		composer.addImplementedInterface(TWICEModuleInstantiator.class
				.getName()
				+ "<"
