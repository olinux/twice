...
public class MobileInterface {
	...
	private FlowPanel controlbar = new FlowPanel();
	Menu menu  = new Menu();
	Button others = new Button();

	private MobileKeyboard keyboardButton = new MobileKeyboard();
	private Button hideKeyboard = new Button();
	private AbsolutePanel keyboardPanel = new AbsolutePanel();
